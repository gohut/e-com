...
const relatedProducts: Product[] = [
  { id: 1, title: "100% Cotton Black Slim Fit Shirt", price: "Rs. 999", originalPrice: "Rs. 1999", image: "https://images.unsplash.com/photo-1617127365659-c47fa864d8bc?auto=format&fit=crop&w=700&q=80" },
  { id: 2, title: "100% Cotton Collared Polo T Shirt", price: "Rs. 649", originalPrice: "Rs. 1199", image: "https://images.unsplash.com/photo-1593032465171-8bd0a8d0f93e?auto=format&fit=crop&w=700&q=80" },
  { id: 3, title: "100% Cotton Slim Fit Shirt", price: "Rs. 629", originalPrice: "Rs. 699", image: "https://images.unsplash.com/photo-1646176724329-8a12512df18b?q=80&w=1965&auto=format&fit=crop" },
  { id: 4, title: "Women Printed Shirt", price: "Rs. 999", originalPrice: "Rs. 1999", image: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=700&q=80" },
  { id: 5, title: "Grey Stripes Slim Fit Luxe Shirt", price: "Rs. 999", originalPrice: "Rs. 1999", image: "https://images.unsplash.com/photo-1603252109303-2751441dd157?auto=format&fit=crop&w=700&q=80" },
  { id: 6, title: "Slim Fit Striped Textured Shirt", price: "Rs. 849", originalPrice: "Rs. 1299", image: "https://images.unsplash.com/photo-1610652492500-ded49ceeb378?auto=format&fit=crop&w=700&q=80" },
];
      ...
      <main className={styles.main}>
        <section className={styles.hero}>
          ...
          <aside className={styles.details}>
            ...
            <p className={styles.price}>Rs. 1599 <span>Rs. 1999</span></p>
            ...
            <div className={styles.offers}><h3>Available offers</h3><div className={styles.offerGrid}><article><h4>MYDRESS5</h4><p>5% off on your first order and extra discount on prepaid orders.</p></article><article><h4>MYDRESS10</h4><p>10% off on orders above Rs. 1499 and free shipping on all orders.</p></article></div></div>
        ...
        <section className={styles.ratingsBlock}>
          <div className={styles.ratingLeft}><h3>Customer Ratings</h3><p className={styles.stars}>5 stars</p><p className={styles.score}>4.6 / 5</p><p className={styles.count}>2689 global ratings</p></div>
